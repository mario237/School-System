...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <!-- logo -->
    <div class="text-left navbar-brand-wrapper pb-2">
        <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}">
            <img src="{{ URL::asset('assets/images/school.png') }}" alt="">
            <span style="font-size: 16px; font-weight: bold">{{ trans('main_trans.Main_title') }}</span>
        </a>
        <a class="navbar-brand brand-logo-mini" href="{{ url('/dashboard') }}"><img src="{{ URL::asset('assets/images/school.png') }}"
                alt=""></a>
