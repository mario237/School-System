            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('Grades.destroy', $Grade->id) }}" method="post">
                                                  ...
                                                  <div class="row">
                                                     ...
                                                     <div class="col">
                                                         <p class="lead"> {{ trans('Grades_trans.Warning_Grade') }}</p>
                                                     </div>
