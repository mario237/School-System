        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <button type="button" class="button x-small" id="btn_delete_all" data-toggle="modal">
                    ...
                    <div class="table-responsive">
                        <table id="myTable" class="table  table-hover table-sm table-bordered p-0"
                               data-page-length="50"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ route('Classrooms.update', $My_Class->id) }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   ...
                                                                   name="Name_class_en" id="Name_class_en">
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="form-group">
                                                        <label
                                                            for="Grade_Name">{{ trans('My_Classes_trans.Name_Grade') }}
                                                            :</label>
                                                        <select class="form-control form-control-lg h-100 px-2"
                                                                id="Grade_Name" name="Grade_Id">

                                                            @foreach ($Grades as $Grade)
                                                                <option
                                                                    value="{{ $Grade->id }}" {{ $My_Class->Grades->id === $Grade->id ? 'selected' : '' }}>
                                                                    {{ $Grade->Name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit"
                                                                class="btn btn-primary">{{ trans('Grades_trans.Edit') }}</button>
                                                    </div>
                                                </form>
                                        ...
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="box">
                                                        <select class="fancyselect" name="Grade_Id" id="Grade_Name">
                                                            @foreach ($Grades as $Grade)
                                                                <option
        ...
        <div class="modal fade" id="delete_all" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('delete_classes') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="modal-body">
                            {{ trans('My_Classes_trans.Warning_class') }}
                            <input class="text" type="hidden" id="arrayOfClasses" name="arrayOfClasses" value=''>
                        </div>
        ...
        $(function () {
            $("#btn_delete_all").click(function () {
                ...
                if (selected.length > 0) {
                    ...
                    if (selected.indexOf('on') === 0) {
                        selected.splice(0, 1);
                    }


                    $('input[id="arrayOfClasses"]').val(selected);
