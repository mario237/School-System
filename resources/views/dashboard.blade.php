                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active show" id="months-tab" data-toggle="tab"
                                                    href="#" role="tab" aria-controls="months"
                                                    aria-selected="true"> Months</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="year-tab" data-toggle="tab" href="#"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control form-white" placeholder="Enter name"
                                                        type="text" name="category-name" id="name"/>
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="color" class="control-label">Choose Category Color</label>
                                                    <select id="color" class="form-control form-white"
